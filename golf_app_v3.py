...
def render_content(tab):
    if tab == 'tab-practice':
        ...
        # MULTI-COURSE HOLE ANALYSIS TAB
        return html.Div([
            html.H2('Hole-by-Hole Course Performance Analysis', style={'marginBottom': '10px', 'fontWeight': '400', 'color': '#ffffff'}),
            html.P("Analyze course performance and map strategies across Munster's leading golf layouts. Select any course to view active or simulated baseline stats.", style={'color': '#aaaaaa', 'fontSize': '14px', 'marginBottom': '25px'}),
            
            # Course Selection Panel
            html.Div(
                style={'marginBottom': '20px', 'backgroundColor': '#1e1e1e', 'padding': '20px', 'borderRadius': '8px', 'display': 'flex', 'flexWrap': 'wrap', 'alignItems': 'center', 'gap': '25px'},\
                children=[
                    html.Div(
                        style={'display': 'flex', 'alignItems': 'center', 'gap': '10px'},\
                        children=[
                            html.Label("Select Golf Course:", style={'fontWeight': 'bold', 'fontSize': '15px', 'color': '#ffffff'}),
                            dcc.Dropdown(
                                id='course-selector',
                                options=[{'label': c, 'value': c} for c in sorted(COURSES_DB.keys())],
                                value="Fermoy Golf Club",
                                style={'width': '300px', 'color': '#121212', 'fontFamily': 'inherit'}\
                            ),
                        ]
                    ),
                    html.Span(id='course-status-badge', style={'padding': '6px 14px', 'borderRadius': '15px', 'fontSize': '13px', 'fontWeight': 'bold'})
                ]
            ),
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            html.H5("COURSE SCORECARD", style={'margin': '0', 'color': '#aaaaaa', 'fontSize': '12px', 'letterSpacing': '1px'}),
                            html.H3(id='overview-par-yards', style={'margin': '10px 0 5px 0', 'fontSize': '24px', 'color': '#2ecc71'}),
                            html.P(id='overview-location', style={'margin': '0', 'fontSize': '12px', 'color': '#888888'})\
                        ]
                    ),
                    # Metric 2: Best Holes
                    html.Div(
                        ...
                        children=[
                            ...
                            html.H3(id='overview-best-holes', style={'margin': '10px 0 5px 0', 'fontSize': '24px', 'color': '#2ecc71'}),
                            html.P(id='overview-best-sg', style={'margin': '0', 'fontSize': '12px', 'color': '#888888'})\
                        ]
                    ),
                    # Metric 3: Biggest Bottleneck
                    html.Div(
                        ...
                        children=[
                            ...
                            html.H3(id='overview-worst-hole', style={'margin': '10px 0 5px 0', 'fontSize': '24px', 'color': '#ff4d4d'}),
                            html.P(id='overview-worst-details', style={'margin': '0', 'fontSize': '12px', 'color': '#888888'})\
                        ]
                    ),
                    ...
                    html.Div(
                        style={'flex': '1', 'minWidth': '220px', 'backgroundColor': '#1e1e1e', 'padding': '20px', 'borderRadius': '8px', 'borderLeft': '5px solid #ff4d4d', 'textAlign': 'center'},\
                        children=[
                            html.H5("COURSE AVG SCORE", style={'margin': '0', 'color': '#aaaaaa', 'fontSize': '12px', 'letterSpacing': '1px'}),
                            html.H3(id='overview-avg-score', style={'margin': '10px 0 5px 0', 'fontSize': '24px', 'color': '#ff4d4d'}),
                            html.P(id='overview-overall-sg', style={'margin': '0', 'fontSize': '12px', 'color': '#888888'})\
                        ]
                    )
                ]
            ),
            
            # Course-Wide Strokes Gained Bar Chart Card
            html.Div(
                style={'backgroundColor': '#1e1e1e', 'padding': '20px', 'borderRadius': '8px', 'boxShadow': '0 4px 6px rgba(0,0,0,0.3)', 'marginBottom': '30px'},\
                children=[
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.P("Select a hole from the course scorecard to view scoring spreads, GIR percentages, putting telemetry, and targeted caddie insights.", style={'margin': '0', 'color': '#aaaaaa', 'fontSize': '14px'})\
                ]
            ),
...
def update_course_selection(course_name):
    ...
    if has_real:
        badge_style = {'backgroundColor': '#1b5e20', 'color': '#2ecc71', 'padding': '6px 14px', 'borderRadius': '15px', 'fontSize': '13px', 'fontWeight': 'bold'}
        banner_child = None
    else:
        badge_style = {'backgroundColor': '#4a2306', 'color': '#f39c12', 'padding': '6px 14px', 'borderRadius': '15px', 'fontSize': '13px', 'fontWeight': 'bold'}
